...
ksemillas  <- c(127081, 131071, 137131, 139967, 149209) #reemplazar por las propias semillas
...
{
for( vmin_split  in  c( 1000, 700, 400, 200, 100, 50 )  )
{
for( vmin_bucket  in  c( 700, 600, 400, 200, 100 )  )
{
