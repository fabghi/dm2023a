...
PARAM  <- list()
PARAM$experimento  <- "ZZ5910-jug"
PARAM$exp_input  <- "HT5510-jug"

#Atencion, quecada modelos se procesa con 5 semillas, ajuste a SUS necesidades
...
PARAM$semillas  <- c( 127081, 131071, 137131, 139967, 149209 ) #reemplazar por las propias semillas
