...
PARAM  <- list()
PARAM$experimento <- "TS5410-jug"

PARAM$exp_input  <- "FE5310-jug"

# me salteo los meses duros de pandemia, pero llego hasta 201907 en training
# entreno en 18 meses

PARAM$future       <- c( 202109 )
PARAM$final_train  <- c( 202107, 202106, 202105, 202104 )

PARAM$train$training     <- c( 202105, 202104, 202103, 202102 )
...
PARAM$train$semilla  <- 127081  # cambiar por su propia semilla  !!! 
